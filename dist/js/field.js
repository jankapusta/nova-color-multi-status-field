...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.component('index-nova-color-multi-status-field', __webpack_require__(4));
  Vue.component('detail-nova-color-multi-status-field', __webpack_require__(7));
  Vue.component('form-nova-color-multi-status-field', __webpack_require__(10));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['resource', 'resourceName', 'resourceId', 'field', 'setDefaultParams', 'prepareDataset'],
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fill: function fill(formData) {
      var dataset = void 0;
      if (this.useArray) {
        dataset = this.value.map(function (one) {
          return one['oneValue'];
        });
      } else {
        dataset = {};
