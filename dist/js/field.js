...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.mixin({
    methods: {
      setDefaultParams: function setDefaultParams(field) {
      ...
      prepareDataset: function prepareDataset(field) {
        ...
        return Object.keys(field.value).map(function (index) {
          return {
            key: index,
            oneValue: field.value[index],
            color: _this.calculateColor(field.colorMap, field.value[index])
          };
        });
      },
      calculateColor: function calculateColor(colorMap, val) {
  ...
  Vue.component('index-nova-color-multi-status-field', __webpack_require__(3));
  Vue.component('detail-nova-color-multi-status-field', __webpack_require__(6));
  Vue.component('form-nova-color-multi-status-field', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    mousedown: function mousedown(ev, textKey, textName) {
    ...
    mouseenter: function mouseenter(ev, textKey, textName) {
      this.tooltip = true;
      this.tooltipKey = textKey;
      this.tooltipName = textName;
      this.pos = {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm._l(_vm.dataset, function(oneItem, key) {
        return _c("div", { staticClass: "inline-block" }, [
          _c(
            "div",
            {
              staticClass: "colorMultiStatusIcon",
              on: {
                mouseenter: function($event) {
                  return _vm.mouseenter($event, oneItem.key, oneItem.oneValue)
                },
                ...
                mousedown: function($event) {
                  return _vm.mousedown($event, oneItem.key, oneItem.oneValue)
                }
              }
            },
            [
      ...
      _vm._v(" "),
      _vm.field.showTooltips && _vm.tooltip
        ? _c(
            "div",
            {
              staticClass: "colorMultiStatusTooltip absolute 10",
              style: "left: " + _vm.pos.left + "px; top: " + _vm.pos.top + "px"
            },
            [
              _c(
                "div",
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['resource', 'resourceName', 'resourceId', 'field', 'setDefaultParams', 'prepareDataset', 'tooltip', 'pos', 'tooltipName', 'tooltipKey', 'useArray'],
  methods: {
    mousedown: function mousedown(ev, textKey, textName) {
      this.tooltip = !this.tooltip;
      this.tooltipKey = textKey;
            ...
            _vm.field.showTooltips && _vm.tooltip
              ? _c(
                  "div",
                  {
                    staticClass: "colorMultiStatusTooltip absolute 10",
                    style:
                      "left: " + _vm.pos.left + "px; top: " + _vm.pos.top + "px"
                  },
                  [
                    _c(
                      "div",
